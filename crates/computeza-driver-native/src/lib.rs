...
//!
//! v1.0 driver per spec section 3.2 Tier 2. Implements [`computeza_core::Driver`]
//! against the host's service manager:
//!
//! - **Linux** -- systemd unit lifecycle (spec section 10.3)
//! - **macOS** -- launchd plist lifecycle (spec section 10.3)
//! - **Windows** -- Windows Services via SCM (spec section 10.3)
//!
...
//! demonstration of the autonomous-installer mandate (spec section 2.1). macOS
