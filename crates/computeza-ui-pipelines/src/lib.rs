...
//!
//! Per spec section 5, this is the single largest UX surface in the product. Two
...
//!    Rust SDK or YAML CDK artifacts (spec section 5.8).
//!
...
//!
//! Scaffold stub. Implementation is pending. Note: spec section 4.1 acknowledges
