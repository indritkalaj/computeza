...
//!
//! Per spec §11.6, Provider channel partners get white-label rights:
...
//! `indigo-900` … `slate-100` token names from spec §4.3 to partner
//! overrides) and the runtime that applies a theme to the Tailwind
//! CSS variable layer.
//!
//! The default theme is the indigo + orange palette from spec §4.3; any
